        ...
        <el-main>
          ...
          <div style="margin:10px 0">
            ...
            >
              ...
              <el-button slot="reference" type="primary" @click="">批量刪除<i class="el-icon-circle-plus-outline"></i></el-button>
            </el-popconfirm>
...
export default {
  ...
  methods: {
    ...
    handleDelete(id) {
      this.request.delete("/api/user/" + id)
          .then(res => {
            console.log(res)
            if (res) {
    ...
    handleBatchDelete() {
      ...
      console.log(ids)
      this.request.post("/api/user/delBatch",ids)
          .then(res => {
            console.log(res)
            if (res) {
